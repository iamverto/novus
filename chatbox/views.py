    ...
    if request.is_ajax():
        ...
        if name and email and text:
            ...
            list = [
                ...
                'priyanshukumar986@gmail.com',
                'priyanshukumar986@gmail.com',
                'linuxhackr7@gmail.com',
                'priyanshukumar986@gmail.com',
            ]
            email_to_user = EmailMessage(subject=subject, body=body, to=list)
            email_to_user.send()

            email = EmailMessage(subject='You have one more message from site', body=message_to_admin, to=['ceo.novusorg@gmail.com'])
